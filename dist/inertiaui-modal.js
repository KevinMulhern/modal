...
let rr = null, nr = null, me = null, Ve = {}, pt = [], be = {};
const ln = ({ children: e }) => {
  ...
  class a {
    constructor(u, c, v, y, p) {
      ...
      if (this.id = c.id ?? ft(), this.isOpen = !1, this.shouldRender = !1, this.listeners = {}, this.component = u, this.props = c.props, this.response = c, this.config = v ?? {}, this.onCloseCallback = y, this.afterLeaveCallback = p, be[this.id]) {
        this.config = {
          ...this.config,
          ...be[this.id].config ?? {}
        };
  ...
  const g = (h, u = {}) => w(
    ...
    return new Promise((R, k) => {
      ...
      const [j, we] = Yr(u, h || "", c, O);
      let ce = N;
      if (t.length === 0 && N && (me = typeof window < "u" ? window.location.href : ""), v = {
        ...v,
        Accept: "text/html, application/xhtml+xml",
  ...
  const a = (m) => {
    var g;
    return m.headers["X-InertiaUI-Modal-Base-Url"] = me ?? (i ? (g = r.props._inertiaui_modal) == null ? void 0 : g.baseUrl : null), m;
  };
  ...
  }, [(d = r.props) == null ? void 0 : d._inertiaui_modal]), /* @__PURE__ */ ve(Mt, { children: [
    e,
...
const ar = Pt(({ name: e, children: t, onFocus: r = null, onBlur: n = null, onClose: l = null, onSuccess: i = null, ...a }, s) => {
  ...
  return L(() => {
    ...
    [f]
  ), (f == null ? void 0 : f.shouldRender) && /* @__PURE__ */ ve(Mt, { children: [
    typeof t == "function" ? t({
...
function zl(e, { ownerDocument: t, container: r, containers: n, previousActiveElement: l }) {
  ...
  $r(t == null ? void 0 : t.defaultView, "focus", (s) => {
    ...
    if (!d) return;
    let m = s.target;
    he(m) ? Cr(o, m) ? (l.current = m, te(m)) : (s.preventDefault(), s.stopPropagation(), te(d)) : te(l.current);
  }, !0);
}
function Cr(e, t) {
...
function Nr(e, t) {
  let r = ge(e), n = S([]), l = Nt(), i = rt(), a = M((b, f = oe.Hidden) => {
...
function Yl(e, t) {
  ...
  let we = D && !N, ce = N && O && D, Q = S(!1), A = Nr(() => {
  ...
  let ct = !(!l || !y || !j || we), [, T] = gl(ct, u, O, { start: $e, end: le }), Ue = de({ ref: p, className: ((n = xt(h.className, ce && d, ce && m, T.enter && d, T.enter && T.closed && m, T.enter && !T.closed && g, T.leave && b, T.leave && !T.closed && f, T.leave && T.closed && E, !T.transition && O && w)) == null ? void 0 : n.trim()) || void 0, ...vl(T) }), Oe = 0;
...
let er = V(function(e, t) {
  ...
  let [j, we] = Pn(), ce = _(() => [{ dialogState: u, close: y, setTitleId: p, unmount: m }, c], [u, y, p, m, c]), Q = je({ open: u === 0 }), A = { ref: E, id: n, role: s, tabIndex: -1, "aria-modal": d ? void 0 : u === 0 ? !0 : void 0, "aria-labelledby": c.titleId, "aria-describedby": j, unmount: m }, $e = !Il(), le = fe.None;
  x && !d && (le |= fe.RestoreFocus, le |= fe.TabLock, o && (le |= fe.AutoFocus), $e && (le |= fe.InitialFocus));
  let ct = G();
  return $.createElement($l, null, $.createElement(Jt, { force: !0 }, $.createElement(Fl, null, $.createElement(It.Provider, { value: ce }, $.createElement(Mr, { target: f }, $.createElement(Jt, { force: !1 }, $.createElement(we, { slot: Q }, $.createElement(N, null, $.createElement(Hl, { initialFocus: a, initialFocusFallback: f, containers: I, features: le }, $.createElement(Fn, { value: y }, ct({ ourProps: A, theirProps: g, slot: Q, defaultTag: ni, features: li, visible: u === 0, name: "Dialog" })))))))))));
...
const Ni = (e) => (t) => (t.default.layout = (r) => Re(e, {}, r), t);
export {
  sn as Deferred,
  ar as HeadlessModal,
  gi as Modal,
